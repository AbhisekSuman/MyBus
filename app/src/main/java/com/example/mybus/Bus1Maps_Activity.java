...
public class Bus1Maps_Activity extends FragmentActivity implements OnMapReadyCallback, LocationListener {

    private GoogleMap mMap;
    private Bus1locationMapsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = Bus1locationMapsBinding.inflate(getLayoutInflater());
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    try {
                        ...
                        Toast.makeText(Bus1Maps_Activity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
            }
